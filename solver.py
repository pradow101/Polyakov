...
T_vals = np.linspace(0.0001, 0.25, 150)
...
#     try:
#         solution = minimize(lambda vars: potencial(vars,u,T), chuteinit, tol=1e-11)
#         return solution
...
#             results.append((T, phi, phib, M))
#         else:
#             print(f"Minimization failed for T={T}")
#     return results
...
# print(phib_vals_min)
# chuteinit = np.array([0.1, 0.1, 0.3]) 
# u = 0.34
# T = 0.1
